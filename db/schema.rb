...
ActiveRecord::Schema.define(version: 20160116083713) do
  ...
  add_index "normals", ["email"], name: "index_normals_on_email", unique: true
  add_index "normals", ["normalname"], name: "index_normals_on_normalname", unique: true
  add_index "normals", ["reset_password_token"], name: "index_normals_on_reset_password_token", unique: true
